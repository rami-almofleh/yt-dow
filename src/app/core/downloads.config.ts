...
export const DOWNLOAD_LINKS: Record<DesktopOs, string> = {
  mac: 'https://github.com/rami-almofleh/yt-dow/releases/latest/download/reelio-mac.dmg',
  windows: 'https://github.com/rami-almofleh/yt-dow/releases/latest/download/reelio-win.exe',
  linux: 'https://github.com/rami-almofleh/yt-dow/releases/latest/download/reelio-linux.AppImage',
};
